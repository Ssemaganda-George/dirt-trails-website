        ...
        <div className="grid gap-12 xl:grid-cols-[1.1fr_0.9fr] items-start">
          <div className="max-w-2xl">
            ...
            <p className="mt-8 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
              Secure Digital tools designed to connect bookings, distribution and supplier workflows automatically with premium business research and partner support.
            </p>
