    ...
    <section className="relative h-[30vh] min-h-[400px] flex flex-col overflow-hidden">
      ...
      <div className="absolute bottom-2 right-3 z-20">
        <button 
          ...
          className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-full p-1 text-white hover:bg-white/30 transition-all duration-300 animate-bounce"
