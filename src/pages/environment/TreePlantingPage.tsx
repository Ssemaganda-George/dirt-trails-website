...
const TreePlantingPage = () => {
  return (
    <div className="container mx-auto px-4 py-16 bg-cream min-h-screen">
      <div className="mb-16 text-center">
        <div className="inline-flex items-center justify-center p-3 bg-cream rounded-full mb-4 shadow-lg">
          <TreePine className="h-8 w-8 text-accent animate-pulse" />
        </div>
        <h1 className="text-4xl font-serif mb-4 text-brown-900">Tree Planting Initiative</h1>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <Card className="text-center border border-cream shadow-lg hover:shadow-xl transition-shadow duration-300 animate-fade-in delay-300">
          <CardContent className="pt-6">
            <TreePine className="h-10 w-10 text-accent mx-auto mb-2 animate-bounce" />
            <h3 className="text-3xl font-serif text-brown-900 animate-count-up">100+</h3>
            <p className="text-brown-600">Trees Planted</p>
          </CardContent>
        </Card>
        <Card className="text-center border border-cream shadow-lg hover:shadow-xl transition-shadow duration-300 animate-fade-in delay-400">
          <CardContent className="pt-6">
            <TrendingUp className="h-10 w-10 text-accent mx-auto mb-2 animate-bounce delay-100" />
            <h3 className="text-3xl font-serif text-brown-900 animate-count-up">100+ Tons</h3>
            <p className="text-brown-600">CO₂ Offset Annually</p>
          </CardContent>
        </Card>
        <Card className="text-center border border-cream shadow-lg hover:shadow-xl transition-shadow duration-300 animate-fade-in delay-500">
          <CardContent className="pt-6">
            <Users className="h-10 w-10 text-accent mx-auto mb-2 animate-bounce delay-200" />
            <h3 className="text-3xl font-serif text-brown-900 animate-count-up">20+</h3>
            <p className="text-brown-600">Communities Supported</p>
          </CardContent>
        </Card>
      </div>
      
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        <Card className="border border-cream shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in delay-600">
          <CardHeader className="bg-cream rounded-t-lg">
            <CardTitle className="text-brown-900 font-serif">How It Works</CardTitle>
            <CardDescription className="text-brown-600">Our tree planting process explained</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="space-y-6">
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                <div className="bg-accent p-2 rounded-full mr-4">
                  <Leaf className="h-5 w-5 text-white" />
                </div>
                <div>
                  <h3 className="font-serif text-brown-900">Add the Tree Planting Option</h3>
                  <p className="text-brown-600">During checkout, add the $5+ tree planting option to your booking.</p>
                </div>
              </div>
              ...
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                ...
                <div>
                  <h3 className="font-serif text-brown-900">We Plant Native Trees</h3>
                  <p className="text-brown-600">Our local partners plant native tree species in designated conservation areas.</p>
                </div>
              </div>
              ...
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                ...
                <div>
                  <h3 className="font-serif text-brown-900">Receive Your Certificate</h3>
                  <p className="text-brown-600">Get a digital certificate with details about your contribution.</p>
                </div>
              </div>
              ...
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                ...
                <div>
                  <h3 className="font-serif text-brown-900">Track Your Trees</h3>
                  <p className="text-brown-600">Use your unique tracking link to monitor the growth of your trees.</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 animate-fade-in delay-700">
          <CardHeader>
            <CardTitle className="text-brown-900 font-serif">Why Plant Trees in East Africa?</CardTitle>
            <CardDescription className="text-brown-600">Environmental and social benefits</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                <Leaf className="h-5 w-5 text-accent mr-3 mt-0.5" />
                <div>
                  <span className="font-semibold text-brown-900">Combat Climate Change:</span> <span className="text-brown-600">Trees absorb CO₂, storing carbon and releasing oxygen.</span>
                </div>
              </div>
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                <MapPin className="h-5 w-5 text-accent mr-3 mt-0.5" />
                <div>
                  <span className="font-semibold text-brown-900">Prevent Soil Erosion:</span> <span className="text-brown-600">Tree roots help bind soil together, preventing erosion.</span>
                </div>
              </div>
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                <Award className="h-5 w-5 text-accent mr-3 mt-0.5" />
                <div>
                  <span className="font-semibold text-brown-900">Support Biodiversity:</span> <span className="text-brown-600">Native trees provide habitat for local wildlife.</span>
                </div>
              </div>
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                <Users className="h-5 w-5 text-accent mr-3 mt-0.5" />
                <div>
                  <span className="font-semibold text-brown-900">Community Benefits:</span> <span className="text-brown-600">Our program creates jobs and sustainable income for local communities.</span>
                </div>
              </div>
              <div className="flex items-start hover:bg-cream p-3 rounded-lg transition-colors duration-200">
                <TrendingUp className="h-5 w-5 text-accent mr-3 mt-0.5" />
                <div>
                  <span className="font-semibold text-brown-900">Water Security:</span> <span className="text-brown-600">Trees help regulate water cycles and improve water quality.</span>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <div className="mb-16 animate-fade-in delay-800">
        <h2 className="text-2xl font-serif text-center mb-8 text-brown-900">What Our Partners Say</h2>
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="border border-cream shadow-lg hover:shadow-xl transition-all duration-300">
            <CardContent className="pt-6">
              <Quote className="h-8 w-8 text-accent mb-4 animate-pulse" />
              ...
              <p className="font-semibold text-brown-900">- George, Founder, Green Trails Africa</p>
            </CardContent>
          </Card>
          <Card className="border border-cream shadow-lg hover:shadow-xl transition-all duration-300">
            <CardContent className="pt-6">
              <Quote className="h-8 w-8 text-accent mb-4 animate-pulse delay-100" />
              <p className="text-brown-600 mb-4 italic">
                "Partnering with them has helped us combat climate change while supporting biodiversity in East Africa."
              </p>
              <p className="font-semibold text-brown-900">- Patrick, Conservation Expert, AgriMate Farm</p>
            </CardContent>
          </Card>
        </div>
      </div>
      
      <div className="mb-16 animate-fade-in delay-900">
        <h2 className="text-2xl font-serif text-center mb-8 text-brown-900">Our Planting Locations</h2>
      ...
      <div className="text-center mb-8 animate-fade-in delay-1000">
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="bg-accent hover:bg-accent/90 text-white shadow-lg hover:shadow-xl transition-all duration-300" asChild>
            <Link to="/tours" state={{ from: 'tree-planting' }}>
              Browse Tours & Add Tree Planting
            </Link>
          </Button>
          <Button size="lg" variant="outline" className="border-accent text-accent hover:bg-accent hover:text-white shadow-lg hover:shadow-xl transition-all duration-300" asChild>
      ...
      <div className="text-center border-t border-brown-200 pt-8 animate-fade-in delay-1100">
        <p className="text-sm text-brown-600">
          For more information, visit our <Link to="/about" className="text-accent hover:underline transition-colors">About Us</Link> page or <Link to="/contact" className="text-accent hover:underline transition-colors">contact us</Link> directly.
        </p>
      </div>
