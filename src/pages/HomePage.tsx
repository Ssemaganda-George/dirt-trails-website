...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {showWelcome && (
        <div className={`fixed inset-0 z-50 flex flex-col items-center justify-center min-h-screen bg-cream p-2 sm:p-6 transition-opacity duration-700 ${fadeOut ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          <div className="max-w-7xl w-full bg-white rounded-xl shadow-lg p-4 sm:p-10 text-center overflow-y-auto max-h-[90vh]">
            <h1 className="text-4xl font-serif mb-6 text-brown-900 tracking-tight">Welcome to Dirt Trails Safaris</h1>
            ...
            <button
              className="mt-2 px-8 py-3 bg-accent text-white text-lg font-semibold rounded-lg shadow-lg hover:bg-accent/90 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-accent/50 w-full sm:w-auto flex items-center justify-center gap-2"
