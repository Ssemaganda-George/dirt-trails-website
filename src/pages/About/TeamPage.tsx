...
const team = [
  ...
  },
  {
    ...
    bio: 'Clarisa coordinates logistics, guest services and communications so every travel experience is smooth, memorable and reflects our operational standards.',
    accordion: [
      { title: 'Expertise', content: 'Guest services, planning and partner communication.' },
      { title: 'Background', content: 'Bachelor of Science in Hospitality Management from Makerere University.' },
    ],
    linkedin: 'https://www.linkedin.com/in/clarissa04/',
    twitter: '#',
    instagram: '#',
    email: '#',
  },
